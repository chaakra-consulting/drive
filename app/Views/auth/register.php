											...
											<form action="<?= route_to('register') ?>" method="post">
												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<div class="input-group-append">
															<button class="btn btn-light toggle-password" type="button" data-target="#pass_confirm">
																<i class="icon ion-md-eye"></i>
															</button>
														</div>
													</div>
	...
	<script>
		$(document).ready(function() {
			$(".toggle-password").click(function() {
				// Find the target input and the icon inside the clicked button
				var targetSelector = $(this).data("target");
				var passwordInput = $(targetSelector);
				var icon = $(this).find("i");

				// Toggle the type attribute and swap the icon classes
				if (passwordInput.attr("type") === "password") {
					passwordInput.attr("type", "text");
					icon.removeClass("ion-md-eye").addClass("ion-md-eye-off");
				} else {
					passwordInput.attr("type", "password");
					icon.removeClass("ion-md-eye-off").addClass("ion-md-eye");
				}
			});
		});
	</script>

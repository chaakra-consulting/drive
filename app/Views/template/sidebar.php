...
<aside class="app-sidebar sidebar-scroll">
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			<?php endif; ?>
			<li class="slide">
				<a class="side-menu__item" data-bs-toggle="slide" href="<?= route_to('sync-login-sso'); ?>">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clouds-fill" viewBox="0 0 24 24">

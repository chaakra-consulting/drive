				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="index.html"><img src="<?= base_url(); ?>/assets-themes/img/brand/logo.png" class="logo-1"
									alt="logo"></a>
							<a href="index.html"><img src="<?= base_url(); ?>/assets-themes/img/brand/logo-white.png" class="dark-logo-1"
									alt="logo"></a>
							<a href="index.html"><img src="<?= base_url(); ?>/assets-themes/img/brand/favicon.png" class="logo-2"
									alt="logo"></a>
							<a href="index.html"><img src="<?= base_url(); ?>/assets-themes/img/brand/favicon-white.png" class="dark-logo-2"
									alt="logo"></a>
						</div>
